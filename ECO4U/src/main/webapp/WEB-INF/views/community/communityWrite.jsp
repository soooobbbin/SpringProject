...
<div class="align-center">
	...
	<form:form action="write.do" modelAttribute="communityVO"
		...
		<label for="c_auth">공지</label>
			<input type='hidden' name='c_auth' value='0' id='c_auth_hidden'>
			<input type='checkbox' name='c_auth' value='1' id='c_auth' /> 공지로 지정합니다.
		</c:if><br><br></li>
		...
		<li><label for="c_category">카테고리</label>
			...
			<li><label for="c_title">제목</label>
				<form:input path="c_title" id="c_title" style="width:485px;"/>
