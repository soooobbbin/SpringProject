...
<div class="page-main2">
	...
	<div class="zero" style="display:none;">
		...
		<span>
		<!-- &nbsp;&nbsp;<mark>제로웨이스트</mark> -->
		<p class="p-div">제로웨이스트란?</p>
		숫자인 ‘0(제로)’와 쓰레기를 뜻하는 ‘waste’가 합쳐져, 쓰레기가 하나도 없게 만들자는 뜻을 가지고 있습니다. 일회용품 컵, 비닐봉지 등 썩지 않는 쓰레기를 줄여 쓰레기 생산을 최소화하자는 생활습관입니다. 
		<br><br>
	...
	<div class="up" style="display:none;">
		...
		<span>
		<p class="p-div">업사이클링이란?</p>
		업그레이드(upgrade)와 리사이클링(recycling)의 합성어로 버려진 물건을 재활용해 더 가치 있는 제품으로 만드는 '새활용'을 말합니다. 상품에 디자인과 가치를 더해 새로운 쓸모를 갖게 한다는 점에서 유의미할 뿐 아니라, 기존의 새 물건을 생산하고 구매하는 소비 시장을 대신할 수 있다는 점에서 친환경적입니다. 
		<br><br>
	...
	<div class="fair" style="display:none;">
		...
		<span>
		<p class="p-div">공정무역이란?</p>
		저개발국의 생산자와 노동자가 만든 물건을 공정한가격에 거래함으로써 그들의 경제적 자립을 돕고, 소비자에게는 윤리적·환경적 기준에 부합하는
