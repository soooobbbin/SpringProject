...
<div class="align-center" id="header_center">
	...
	<a href="${pageContext.request.contextPath}/product/list.do" id="product">Product</a> <a
		href="${pageContext.request.contextPath}/community/list.do" id="community">Community</a>
	<div id="menu">
		<div class="intro2">
			<a href="${pageContext.request.contextPath}/intro/eco4u.do" id="eco4u">ECO4U</a>
			<br> <br> <br> <a
				href="${pageContext.request.contextPath}/intro/store.do" id="store">Offline
				Store</a>
		</div>
		<div class="product2">
			<a href="${pageContext.request.contextPath}/intro/list.do"
				id="fashion">Fashion</a> <br> <br> <a
				href="${pageContext.request.contextPath}/intro/list.do" id="beauty">Beauty</a>
			<br> <br> <a
				href="${pageContext.request.contextPath}/intro/list.do" id="living">Living</a>
		</div>
		<div class="community2">
			<a href="${pageContext.request.contextPath}/intro/list.do"
				id="communication">Communication</a> <br> <br> <br> <a
				href="${pageContext.request.contextPath}/intro/list.do" id="QnA">QnA</a>
		</div>
	</div>
</div>
<div class="align-right" id="header_right">
	...
	<c:if test="${empty user}">
		...
		<a href="${pageContext.request.contextPath}/member/login.do"> <img
